...
<div class="mt-2 mr-4">
	<div class="row mt-5">
		<div class="form-input ml-3">
			<button type="button" class="btn btn-primary" id="btnAddPromotion">
	...
	<div class="row">
		...
		<div class="col-lg-1">
			<div>
				<span class="ml-1">Show</span> <select id="selectPageSizePromotion"
					class="form-control">
		...
		<div class="col-lg-3">
			<div class="row">
				...
				<div class="input-group rounded mr-3">
					<input id="searchInputPromotion" type="search"
	...
	<div class="card mt-3" id="table-promotion">
		<div style="color: red; font-size: 20px;" class="font-weight-bold"
		...
		<div class="row card-body">
			<table class="table table-bordered table-striped" id="tablePromotion">
				...
				<tbody id="tbodypromotion">
					<c:forEach items="${listOfPromotions}" var="promotion"
						varStatus="loop">
						<tr id="promotion${promotion.promotionId}">
							<td>${promotion.promotionId}</td>
							<td>${promotion.title}</td>
							<td><fmt:formatDate value="${promotion.startTime}"
									pattern="dd/MM/yyyy" /></td>
							<td><fmt:formatDate value="${promotion.endTime}"
									pattern="dd/MM/yyyy" /></td>
							<td>${promotion.discountLevel}</td>
							<td>${promotion.detail}</td>
							<td><a href="#" id="editPromotion"
								value="${promotion.promotionId}"><i class="fas fa-edit"></i></a></td>
							<td><a href="#" id="deletePromotion"
								value="${promotion.promotionId}"><i class="fas fa-trash-alt"></i></a></td>
						</tr>
					</c:forEach>
				...
				<div aria-label="Page navigation example">
					<ul class="pagination" pageIndex="${currentPage}"
						...
						<li class="page-item ${currentPage == numOfPages?'disabled':''}">
							<a id="nextPromotion " class="page-link pagingPromotion" href="#"
							value="${currentPage+1}">Next</a>
						</li>
					</ul>
				</div>
			</div>
