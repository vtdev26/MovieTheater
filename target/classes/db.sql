...
GO
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000001', N'namdinh', CAST(N'2008-11-11' AS Date), N'chuong1@gmail.com', N'hoang van chuong', N'M', N'123456', N'imgage', N'$2a$10$32S8vE0sFBbyIq68fB.lQeOW9F7vXhSbcpMX7NvdNI9WXb1ohZuyi', N'0999999', CAST(N'2008-11-11' AS Date), 0, N'admin', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000002', N'quat lam', CAST(N'1999-10-10' AS Date), N'chuong2@gmail.com', N'do nhu the', N'M', N'234557', N'image2', N'$2a$10$32S8vE0sFBbyIq68fB.lQeOW9F7vXhSbcpMX7NvdNI9WXb1ohZuyi', N'111111', CAST(N'1999-11-11' AS Date), 1, N'user', 2)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000003', N'bach long', CAST(N'1888-08-10' AS Date), N'chuong@gmail.com', N'tran van chien ', N'M', N'111111', N'profile1.jpg', N'$2a$10$32S8vE0sFBbyIq68fB.lQeOW9F7vXhSbcpMX7NvdNI9WXb1ohZuyi', N'111111', CAST(N'2018-11-11' AS Date), 1, N'chuong', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000004', N'giao yen ', CAST(N'2008-10-10' AS Date), N'dieu@gmail.com', N'do vinh ', N'F', N'000000', N'image2', N'$2a$10$32S8vE0sFBbyIq68fB.lQeOW9F7vXhSbcpMX7NvdNI9WXb1ohZuyi', N'111111', CAST(N'2007-09-09' AS Date), 0, N'admin4', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000005', N'ha noi ', CAST(N'2008-10-10' AS Date), N'kien@gmail.com', N'hao an ', N'F', N'111111', N'image2', N'pass', N'111111', CAST(N'2007-09-09' AS Date), 0, N'admin5', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000006', N'quat lam', CAST(N'1228-10-10' AS Date), N'w', N'kim ngan ', N'M', N'111111', N'image2', N'pass', N'111111', CAST(N'2007-09-09' AS Date), 0, N'admin6', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000007', N'ha don', CAST(N'1008-10-10' AS Date), N'chuong7@gmail.com', N'minh vu ', N'F', N'111111', N'image2', N'pass', N'111111', CAST(N'2007-09-09' AS Date), 0, N'admin7', 1)
INSERT [movie_theater].[account] ([account_id], [address], [date_of_birth], [email], [full_name], [gender], [identity_card], [image], [password], [phone_number], [register_date], [status], [username], [role_id]) VALUES (N'G3_0000008', N'hai an ', CAST(N'1983-10-10' AS Date), N'chuong8@gmail.com', N'trung kien ', N'M', N'111111', N'image2', N'pass', N'111111', CAST(N'2007-09-09' AS Date), 0, N'admin8', 1)
GO
...
INSERT [movie_theater].[employee] ([employee_id], [account_id]) VALUES (N'G3_0000006', N'G3_0000006')
INSERT [movie_theater].[employee] ([employee_id], [account_id]) VALUES (N'G3_0000007', N'G3_0000007')
