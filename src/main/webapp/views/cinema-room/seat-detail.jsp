            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
                                ...
                                <c:forEach items="${listRoomSeat}" var="seat">
                                    <c:choose>
                                        <c:when test="${col == 1}">
                                            <tr>
                                                <td>
                                                    <button type="button" class="pushables ${(seat.status==1?'pushable-sold':(seat.seatType==1?'pushable-vip':''))}" data-type="${(seat.seatType==1?'vip':'')}" data-seat-id="${(seat.seatId)}">
                ...
                <div class="row justify-content-center mt-3">
                    <div class="note col-7 text-center">
                        <div class="row">
                            <div class="col-3">
                                <button class="btn-note-item btn btn-success"></button> Seat is selecting
                            </div>
                            <div class="col-3">
                                <button class="btn-note-item btn " style="background-color: red;"></button> Seat is sold
                            </div>
                            <div class="col-3">
                                <button class="btn-note-item btn btn-secondary"></button> Seat can chose
                            </div>
                            <div class="col-3">
                                <button class="btn-note-item btn btn-primary"></button> Seat VIP
                            </div>
                        </div>
                    </div>
                </div>
