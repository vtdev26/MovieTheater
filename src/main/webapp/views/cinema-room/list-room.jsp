                                        ...
                                        <div class="col-lg-3">
                                            <div class="row">
                                                <div class="input-group rounded mr-3">
                                                    <input id="searchInput" type="text" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" value="${roomName}" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 right">
                                                    <div aria-label="Page navigation example">
                                                        <ul class="pagination">
                                                            <li class="page-item ${currentPage == 1?'disabled':''}"><a class="page-link pageWithoutNum" value="Previous" href="#">Previous</a></li>
                                                            <c:forEach begin="1" end="${numOfPages}" var="page">
                                                                <li class="page-item ${currentPage == page?'disabled':''}"><a class="page-link pageWithNum ${currentPage == page?'currentPage':''}" href="#" id="${page}">${page}</a></li>
                                                            </c:forEach>
                                                            <li class="page-item ${currentPage == numOfPages?'disabled':''}"><a class="page-link pageWithoutNum" value="Next" href="#">Next</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
