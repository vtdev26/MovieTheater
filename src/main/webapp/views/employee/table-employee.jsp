    ...
    <div class="col-lg-12 right">
        <div aria-label="Page navigation example">
            <ul class="pagination" pageIndex="${pageIndex}" numOfPages="${numOfPages}">
                <li class="page-item"><a href="#" class="page-link pe-auto"
                                         id="previous">Previous</a></li>
                <c:forEach begin="1" end="${numOfPages}" var="pageIndex">
                    <li class="page-item"><a href="#" class="page-link" id="pageIndex"
...
<!-- Modal -->
<div class="modal fade" id="modalDeleteEmployee" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="cfDeleteEmployee" data-columnDelete=""
