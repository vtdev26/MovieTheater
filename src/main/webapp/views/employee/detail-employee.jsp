...
<div>
    ...
    <form name="formDetailEmployee" id="formDetailEmployee" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div>
                <input type="radio" class="flat" name="gender" id="genderFemale" value="M" checked/> Nam
                <input type="radio" class="flat ml-4" name="gender" id="genderMale" value="F"/> Nữ
            </div>
            <span class="form-message text-danger"></span>
        ...
        <button id="btnSaveEmployee" type="submit" class="btn btn-primary mt-3">
            <i class="fas fa-check"></i> Save
        </button>

        <button id="btnBackEmployee" type="button" class="btn btn-primary mt-3">
