	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed"
				id="ticket_selling" href="#"> <i class="fab fa-cc-amazon-pay"></i>
					<span>Ticket Selling Management</span>
			</a> <a id="employee" class="nav-link collapsed"> <i
					class="fas fa-users"></i> <span>Employee Management</span>
			</a> <a class="nav-link collapsed" href="#" id="movie"> <i
					class="fas fa-film"></i> <span>Movie Management</span>
					...
					class="fas fa-percent"></i> <span>Promotion Management</span>
			</a></li>
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small"><i
									class="fas fa-caret-down mr-3"></i>${accountLogin.userName}</span> <img
