    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <div class="mt-2 mr-4">
                    ...
                    <div class="col-lg-3">
                        <div class="row">
                            <div class="input-group rounded mr-3">
                                <input id="searchInputMovie" type="search" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" value="${searchData}" />
                            ...
                            <div aria-label="Page navigation example">
                                <ul class="pagination" pageIndex="${currentPage}" numOfPages="${numOfPages}">
                                    ...
                                    <c:forEach begin="1" end="${numOfPages}" var="pageIndex">
                                        <li class="page-item ${currentPage == pageIndex?'active':''}"><a class="page-link" href="#" id="pageIndex" value="${pageIndex}">${pageIndex}</a></li>
                                    </c:forEach>
                ...
                <!-- Modal -->
                <div class="modal fade" id="modalDeleteMovie" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                       ...
                       <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="cfDeleteMovie" data-columnDelete="" data-movieId="">Delete
                   </button>
                            </div>
                        </div>
                    </div>
