            ...
            <div>
                ...
                <form action="#" method="post" name="formMovie" id="formMovie" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="movieNameVn" name="movieNameVn" placeholder="Movie Name(VN)" value="${movie.movieNameVn}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fromDate" name="fromDate" value="<fmt:formatDate value='${movie.fromDate}' pattern='yyyy-MM-dd' />">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="toDate" name="toDate" value="<fmt:formatDate value='${movie.toDate}' pattern='yyyy-MM-dd' />">
                    ...
                    <div class="form-group">
                        <label for="movieProductCompany" class="font-weight-bold">Production Company <span class="text-danger">(*)</span></label>
                        <input type="text" class="form-control" id="movieProductCompany" name="movieProductCompany" placeholder="Production Company" value="${movie.movieProductCompany}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="version" name="version" placeholder="Version" value="${movie.version}">
                        ...
                        <div class="custom-control custom-checkbox">
                            <div class="row">
                                <c:forEach items="${types}" var="type">
                                    <div class="col-sm-4">
                                        <div>
                                            <input type="checkbox" class="custom-control-input" name="types" id="${type.typeName}" value="${type.typeId}" ${typeIdss.contains(type.typeId) ? 'checked': ''}> <label class="custom-control-label" for="${type.typeName}">${type.typeName}</label>
                                        </div>
                                    </div>
                                </c:forEach>
                    ...
                    <div class="form-group">
                        <label for="exampleInputSchedule" class="font-weight-bold">Schedule <span class="text-danger">(*)</span></label>
                        <div class="custom-control custom-checkbox">
                            <div class="row">
                                <c:forEach items="${schedules}" var="schedule">
                                    <div class="col-sm-4">
                                        <div>
                                            <input type="checkbox" class="custom-control-input" name="schedules" id="${schedule.scheduleId}" value="${schedule.scheduleId}" ${scheduleIdss.contains(schedule.scheduleId) ? 'checked': ''}>
                                            <label class="custom-control-label" for="${schedule.scheduleId}">${schedule.scheduleTime}</label>
                                        </div>
                                    </div>
                                </c:forEach>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="movieImage" name="movieImage" accept="image/*" onchange="readURL(this);">
                    </div>

                    <button id="btnSaveMovie" type="button" class="btn btn-primary">
                                <i class="fas fa-check"></i> Save
                            </button>

                    <button id="btnBackMovie" type="button" class="btn btn-primary">
